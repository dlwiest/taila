...
import React__default, { useState, useRef, useEffect, useCallback, useContext, useMemo, createContext, forwardRef, cloneElement } from 'react';
import $dGqE5$reactdom, { flushSync, createPortal } from 'react-dom';
...
function $337b884510726a0d$export$c6fdb837b070b4ff(props) {
    ...
    return /*#__PURE__*/ ($dGqE5$reactdom).createPortal(contents, portalContainer);
}
...
function $982254629710d113$export$b95089534ab7c1fd(props) {
    ...
    let delegate = (useMemo)(()=>keyboardDelegate || new ($2a25aae57d74318e$export$a05409b8bb224a5a)(collection, disabledBehavior === "selection" ? new Set() : disabledKeys, ref, collator), [
        keyboardDelegate,
        collection,
        disabledKeys,
        ref,
...
function $bdd25dc72710631f$export$cbd84cdb2e668835(props) {
    ...
    if (state.collection.size <= 300) return /*#__PURE__*/ (React__default).createElement("div", {
    ...
    }, /*#__PURE__*/ (React__default).createElement("input", inputProps), /*#__PURE__*/ (React__default).createElement("label", null, label, /*#__PURE__*/ (React__default).createElement("select", {
        ...selectProps,
        ref: selectRef
        ...
        let item = state.collection.getItem(key);
        if (item.type === "item") return /*#__PURE__*/ (React__default).createElement("option", {
            key: item.key,
            value: item.key
        }, item.textValue);
    }))));
...
function $7135fc7d473fd974$export$7cd71aa5ddd6dc4e(initialCollection) {
    ...
    let document = (useMemo)(()=>new $7135fc7d473fd974$export$b34a105447964f9f(initialCollection || new $7135fc7d473fd974$export$408d25a4e12db025()), [
        initialCollection
    ]);
...
function $64fa3d84918910a7$export$8dc98ba7eadeaa56(props) {
    ...
    }, children) : /*#__PURE__*/ ($dGqE5$reactdom).createPortal(children, $64fa3d84918910a7$var$hiddenFragment);
}
...
const $5cb03073d3f54797$export$d688439359537581 = /*#__PURE__*/ (createContext)({});
...
const $d8f176866e6dc039$export$f55761759794cf55 = /*#__PURE__*/ (createContext)(null);
function $d8f176866e6dc039$var$DropIndicator(props, ref) {
    let { render: render } = (useContext)($d8f176866e6dc039$export$f55761759794cf55);
 ...
 */ const $d8f176866e6dc039$export$62ed72bc21f6b8a6 = /*#__PURE__*/ (forwardRef)($d8f176866e6dc039$var$DropIndicator);
const $d8f176866e6dc039$export$d188a835a7bc5783 = /*#__PURE__*/ (createContext)({});
...
function $eed445e0843c11d0$var$ListBox(props, ref) {
    ...
    if (document) return /*#__PURE__*/ (React__default).createElement(($7135fc7d473fd974$export$813b5978dd974d8), props);
...
function $eed445e0843c11d0$var$StandaloneListBox({ props: props, listBoxRef: listBoxRef }) {
    ...
    return /*#__PURE__*/ (React__default).createElement((React__default).Fragment, null, portal, /*#__PURE__*/ (React__default).createElement($eed445e0843c11d0$var$ListBoxInner, {
        state: state,
        props: props,
...
function $eed445e0843c11d0$var$ListBoxInner({ state: state, props: props, listBoxRef: listBoxRef }) {
    ...
    let children = ($7135fc7d473fd974$export$727c8fc270210f13)({
        ...
        children: (item)=>{
            switch(item.type){
                case "section":
                    return /*#__PURE__*/ (React__default).createElement($eed445e0843c11d0$var$ListBoxSection, {
                        section: item
                    });
                case "separator":
                    return /*#__PURE__*/ (React__default).createElement(($431f98aba6844401$export$1ff3c3f08ae963c0), item.props);
                case "item":
                    return /*#__PURE__*/ (React__default).createElement($eed445e0843c11d0$var$Option, {
                        item: item
                    });
                default:
...
function $eed445e0843c11d0$var$ListBoxSection({ section: section, className: className, style: style }) {
    ...
    let children = ($7135fc7d473fd974$export$727c8fc270210f13)({
        ...
        children: (item)=>{
            switch(item.type){
                case "header":
                    return /*#__PURE__*/ (React__default).createElement($eed445e0843c11d0$var$SectionHeader, {
                        item: item,
...
function $eed445e0843c11d0$var$Option({ item: item }) {
    ...
    return /*#__PURE__*/ (React__default).createElement((React__default).Fragment, null, (dragAndDropHooks === null || dragAndDropHooks === void 0 ? void 0 : dragAndDropHooks.useDropIndicator) && renderDropIndicator({
        type: "item",
        key: item.key,
        dropPosition: "before"
    }), /*#__PURE__*/ (React__default).createElement(ElementType, {
...
function $eed445e0843c11d0$var$ListBoxDropIndicatorWrapper(props, ref) {
    ...
    let { dragAndDropHooks: dragAndDropHooks, dropState: dropState } = (useContext)(($d8f176866e6dc039$export$d188a835a7bc5783));
    ...
    if (isHidden) return null;
    return /*#__PURE__*/ (React__default).createElement($eed445e0843c11d0$var$ListBoxtDropIndicatorForwardRef, {
        ...props,
...
const $eed445e0843c11d0$var$ListBoxtDropIndicatorForwardRef = /*#__PURE__*/ (forwardRef)($eed445e0843c11d0$var$ListBoxtDropIndicator);
 ...
 * over time.
 */ const $0393f8ab869a0f1a$export$c17561cb55d4db30 = /*#__PURE__*/ (forwardRef)($0393f8ab869a0f1a$var$ProgressBar);
...
function $82d7e5349645de74$var$Select(props, ref) {
    ...
    let DOMProps = ($65484d02dcb7eb3e$export$457c3d6518dd4c6f)(props);
    delete DOMProps.id;
    return /*#__PURE__*/ (React__default).createElement((React__default).Fragment, null, /*#__PURE__*/ (React__default).createElement(($64fa3d84918910a7$export$8dc98ba7eadeaa56), null, /*#__PURE__*/ (React__default).createElement(($64fa3d84918910a7$export$2881499e37b75b9a), {
        values: [
            [
    ...
    }, renderProps.children)), /*#__PURE__*/ (React__default).createElement(($64fa3d84918910a7$export$2881499e37b75b9a), {
        values: [
            [
                $82d7e5349645de74$export$7540cee5be7dc19b,
                props
...
const sizeClasses = {
    ...
    md: 'px-2.5 py-1.5 text-md h-10',
    lg: 'px-3 py-2 text-lg h-12',
    xl: 'px-3.5 py-2.5 text-xl h-14',
};
const SpinnerSVG = () => (jsxs("svg", Object.assign({ className: "animate-spin", viewBox: "0 0 64 64", style: { width: '1.25em', height: '1.25em' }, fill: "none", xmlns: "http://www.w3.org/2000/svg", "data-testid": "spinner-svg" }, { children: [jsx("path", { d: "M32 3C35.8083 3 39.5794 3.75011 43.0978 5.20749C46.6163 6.66488 49.8132 8.80101 52.5061 11.4939C55.199 14.1868 57.3351 17.3837 58.7925 20.9022C60.2499 24.4206 61 28.1917 61 32C61 35.8083 60.2499 39.5794 58.7925 43.0978C57.3351 46.6163 55.199 49.8132 52.5061 52.5061C49.8132 55.199 46.6163 57.3351 43.0978 58.7925C39.5794 60.2499 35.8083 61 32 61C28.1917 61 24.4206 60.2499 20.9022 58.7925C17.3837 57.3351 14.1868 55.199 11.4939 52.5061C8.801 49.8132 6.66487 46.6163 5.20749 43.0978C3.7501 39.5794 3 35.8083 3 32C3 28.1917 3.75011 24.4206 5.2075 20.9022C6.66489 17.3837 8.80101 14.1868 11.4939 11.4939C14.1868 8.80099 17.3838 6.66487 20.9022 5.20749C24.4206 3.7501 28.1917 3 32 3L32 3Z", stroke: "currentColor", strokeWidth: "5", strokeLinecap: "round", strokeLinejoin: "round", className: "opacity-50" }), jsx("path", { d: "M32 3C36.5778 3 41.0906 4.08374 45.1692 6.16256C49.2477 8.24138 52.7762 11.2562 55.466 14.9605C58.1558 18.6647 59.9304 22.9531 60.6448 27.4748C61.3591 31.9965 60.9928 36.6232 59.5759 40.9762", stroke: "currentColor", strokeWidth: "5", strokeLinecap: "round", strokeLinejoin: "round", className: "opacity-100" })] })));
const Button = (_a) => {
    var { className, color = "blue", rounded, size = 'md', variant = 'default', loading, children } = _a, rest = __rest(_a, ["className", "color", "rounded", "size", "variant", "loading", "children"]);
    const variants = {
        default: {
    ...
    const classes = clsx('rounded font-semibold shadow-sm inline-flex items-center justify-center gap-x-1.5 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none', backgroundColorClass, sizeClass, textColorClass, hoverColorClass, ringClass, { 'rounded-full': rounded });
    return (jsx($d2b4bc8c273e7be6$export$353f5b6fc5456de1, Object.assign({ className: twMerge(classes, className) }, rest, { children: loading ? jsx(SpinnerSVG, {}) : children })));
};
...
const ForwardRef$1 = React.forwardRef(CheckIcon);
...
const Select = (_a) => {
    ...
    return (jsx($82d7e5349645de74$export$ef9b1a59e592288f, Object.assign({}, rest, { children: ({ isOpen }) => {
            ...
            return (jsxs(Fragment, { children: [jsx($d2b4bc8c273e7be6$export$353f5b6fc5456de1, Object.assign({ className: buttonClasses, ref: buttonRef }, { children: jsx($82d7e5349645de74$export$e288731fd71264f0, { children: ({ isPlaceholder, selectedText }) => {
                            ...
                            } }) })), children && jsx($07b14b47974efb58$export$5b6b19405a83ff9d, Object.assign({ className: ({ isEntering, isExiting }) => clsx('rounded-md shadow-sm ring-1 ring-gray-300 dark:ring-gray-600', {
                            'animate-in fade-in ease-out duration-200': isEntering,
                            'animate-out fade-out ease-in duration-150': isExiting,
...
const SelectItem = (_a) => {
    ...
    return (jsx($eed445e0843c11d0$export$a11e76429ed99b4, Object.assign({ className: ({ isHovered }) => (twMerge(clsx('relative cursor-default select-none py-2 pl-3 pr-9 focus:outline-none cursor-pointer text-gray-900 dark:text-gray-100 hover:text-white', {
            [bgColorClasses[focusColor]]: isHovered,
                    ...
                    }) }, { children: typeof children !== 'string' || children.trim() !== '' ? children : '\u00A0' })), isSelected ? (jsx("span", Object.assign({ className: clsx('absolute inset-y-0 right-0 flex items-center pr-4', {
...
const Spinner = ({ color = 'gray', className }) => {
    ...
    return (jsx($0393f8ab869a0f1a$export$c17561cb55d4db30, Object.assign({ "aria-label": "Loading...", isIndeterminate: true }, { children: jsxs("svg", Object.assign({ className: spinnerClass, viewBox: "0 0 64 64", fill: "none", xmlns: "http://www.w3.org/2000/svg", "data-testid": "spinner-svg" }, { children: [jsx("path", { d: "M32 3C35.8083 3 39.5794 3.75011 43.0978 5.20749C46.6163 6.66488 49.8132 8.80101 52.5061 11.4939C55.199 14.1868 57.3351 17.3837 58.7925 20.9022C60.2499 24.4206 61 28.1917 61 32C61 35.8083 60.2499 39.5794 58.7925 43.0978C57.3351 46.6163 55.199 49.8132 52.5061 52.5061C49.8132 55.199 46.6163 57.3351 43.0978 58.7925C39.5794 60.2499 35.8083 61 32 61C28.1917 61 24.4206 60.2499 20.9022 58.7925C17.3837 57.3351 14.1868 55.199 11.4939 52.5061C8.801 49.8132 6.66487 46.6163 5.20749 43.0978C3.7501 39.5794 3 35.8083 3 32C3 28.1917 3.75011 24.4206 5.2075 20.9022C6.66489 17.3837 8.80101 14.1868 11.4939 11.4939C14.1868 8.80099 17.3838 6.66487 20.9022 5.20749C24.4206 3.7501 28.1917 3 32 3L32 3Z", stroke: "currentColor", strokeWidth: "5", strokeLinecap: "round", strokeLinejoin: "round", className: "opacity-50" }), jsx("path", { d: "M32 3C36.5778 3 41.0906 4.08374 45.1692 6.16256C49.2477 8.24138 52.7762 11.2562 55.466 14.9605C58.1558 18.6647 59.9304 22.9531 60.6448 27.4748C61.3591 31.9965 60.9928 36.6232 59.5759 40.9762", stroke: "currentColor", strokeWidth: "5", strokeLinecap: "round", strokeLinejoin: "round", className: "opacity-100" })] })) })));
};
