...
var Button = function (_a) {
    ...
    return (jsx($d2b4bc8c273e7be6$export$353f5b6fc5456de1, __assign({ className: twMerge(classes, className) }, rest, { children: children })));
};
...
var Input = function (_a) {
    ...
    var classes = clsx('block w-full rounded-md border-0 py-1.5 px-3 bg-transparent text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none sm:text-sm sm:leading-6 disabled:bg-black dark:disabled:bg-white disabled:bg-opacity-5 dark:disabled:bg-opacity-5 disabled:cursor-not-allowed dark:disabled:text-opacity-70 disabled:text-opacity-70', disabledInput, (_b = {},
        ...
        _b));
    return (jsx($3985021b0ad6602f$export$f5b8910cec6cf069, __assign({ className: twMerge(classes, className) }, rest)));
};
...
var Select = function (_a) {
    ...
    var _e = useState(0), buttonWidth = _e[0], setButtonWidth = _e[1];
    var _f = useState(''), buttonBackgroundColor = _f[0], setButtonBackgroundColor = _f[1];
    useEffect(function () {
    ...
    var buttonClasses = twMerge(clsx('relative w-full rounded-md py-1.5 pl-3 pr-10 text-left bg-transparent text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 focus:outline-none sm:text-sm sm:leading-6', disabledInput, (_b = {},
        ...
        _b[focusInnerRingClasses[focusColor]] = !hasError,
        _b)), className);
    return (jsx($82d7e5349645de74$export$ef9b1a59e592288f, __assign({}, rest, { children: function (_a) {
            var isOpen = _a.isOpen;
            setTimeout(function () {
                setIsOpen(isOpen);
            });
            return (jsxs(Fragment, { children: [jsx($d2b4bc8c273e7be6$export$353f5b6fc5456de1, { className: buttonClasses, ref: buttonRef, children: jsx($82d7e5349645de74$export$e288731fd71264f0, { children: function (_a) {
                                var isPlaceholder = _a.isPlaceholder, selectedText = _a.selectedText;
                                var buttonText = isPlaceholder ? jsx("span", { className: "text-gray-400 dark:text-gray-500", children: placeholder || 'Select an item' }) : selectedText;
                            ...
                            } }) }), jsx($07b14b47974efb58$export$5b6b19405a83ff9d, { className: function (_a) {
                        ...
                        }, style: { width: "".concat(buttonWidth, "px"), backgroundColor: buttonBackgroundColor }, children: jsx($eed445e0843c11d0$export$41f133550aa26f48, { className: "w-full max-h-60 overflow-auto bg-whitetext-base focus:outline-none sm:text-sm", items: items, children: children }) })] }));
        } })));
};
...
var SelectItem = function (_a) {
    ...
    return (jsx($eed445e0843c11d0$export$a11e76429ed99b4, __assign({ className: function (_a) {
            var _b;
            ...
            return (jsxs(Fragment, { children: [jsx("div", { className: clsx('block truncate', {
                            'font-semibold': isSelected,
                            'font-normal': !isSelected
                        }), children: children || '\u00A0' }), isSelected ? (jsx("span", { className: clsx('absolute inset-y-0 right-0 flex items-center pr-4', (_b = {},
                            _b[textColorClasses[focusColor]] = !isHovered,
                            _b)), children: jsx(CheckIcon$1, { className: "h-5 w-5", "aria-hidden": "true" }) })) : null] }));
        } })));
};
