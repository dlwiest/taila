...
const Modal = (_a) => {
    ...
    return (jsxRuntime.jsx($f3f84453ead64de5$export$8948f78d83984c69, Object.assign({ isDismissable: true, className: ({ isEntering, isExiting }) => twMerge(clsx('bg-gray-500 bg-opacity-75 fixed w-screen h-screen top-0 left-0', {
