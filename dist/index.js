...
var Button = function (_a) {
    ...
    var _e = variants[variant], textColorClass = _e.textColorClass, backgroundColorClass = _e.backgroundColorClass, hoverColorClass = _e.hoverColorClass, darkBackgroundColorClass = _e.darkBackgroundColorClass, darkHoverColorClass = _e.darkHoverColorClass, ringClass = _e.ringClass, darkRingClass = _e.darkRingClass;
    var sizeClass = sizeClasses[size];
    return (jsxRuntime.jsx($d2b4bc8c273e7be6$export$353f5b6fc5456de1, __assign({ className: twMerge("rounded ".concat(backgroundColorClass, " ").concat(darkBackgroundColorClass, " ").concat(sizeClass, " font-semibold ").concat(textColorClass, " shadow-sm ").concat(hoverColorClass, " ").concat(darkHoverColorClass, " inline-flex items-center gap-x-1.5 disabled:opacity-50 disabled:cursor-not-allowed ").concat(ringClass, " ").concat(darkRingClass), className) }, rest, { children: children })));
};
