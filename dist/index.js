...
var Button = function (_a) {
    ...
    var roundedClass = rounded ? 'rounded-full' : '';
    ...
    return (jsxRuntime.jsx(reactAriaComponents.Button, __assign({ className: twMerge("rounded ".concat(backgroundColorClass, " ").concat(sizeClass, " font-semibold ").concat(textColorClass, " shadow-sm ").concat(hoverColorClass, " inline-flex items-center gap-x-1.5 disabled:opacity-50 disabled:cursor-not-allowed ").concat(ringClass, " ").concat(roundedClass), className) }, rest, { children: children })));
};

var Input = function (_a) {
    var className = _a.className, _b = _a.focusColor, focusColor = _b === void 0 ? 'blue' : _b, hasError = _a.hasError, rest = __rest(_a, ["className", "focusColor", "hasError"]);
    var innerRingClass = hasError ? innerRingClasses['red'] : '';
    var focusInnerRingClass = hasError ? focusInnerRingClasses['red'] : focusInnerRingClasses[focusColor];
    return (jsxRuntime.jsx(reactAriaComponents.Input, __assign({ className: twMerge("block w-full rounded-md border-0 py-1.5 px-3 bg-transparent text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none ".concat(innerRingClass, " ").concat(focusInnerRingClass, " sm:text-sm sm:leading-6"), className) }, rest)));
};
